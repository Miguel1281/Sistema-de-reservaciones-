...
image::Diagrama-de-Componentes.jpg[Diagrama de componentes de sistema hotelero, width=600, align=center]

=== Modelo de conceptos de negocio

image::Modelo de conceptos de negocio.jpg[Modelo de conceptos de negocio de sistema hotelero, width=600, align=center]
